...
class getSecurity_AccessMapService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/behoerde'), [0 => 'ROLE_TOEB'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/beteiligte'), [0 => 'ROLE_MODO'], NULL);
