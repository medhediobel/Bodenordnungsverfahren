 ...
 */
class getVerfahrenRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VerfahrenRepository' shared autowired service.
     *
     * @return \App\Repository\VerfahrenRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VerfahrenRepository.php';

        return $container->privates['App\\Repository\\VerfahrenRepository'] = new \App\Repository\VerfahrenRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
