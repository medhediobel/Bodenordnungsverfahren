...
class Users extends \App\Entity\Users implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Users' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Users' . "\0" . 'email', '' . "\0" . 'App\\Entity\\Users' . "\0" . 'roles', '' . "\0" . 'App\\Entity\\Users' . "\0" . 'password', '' . "\0" . 'App\\Entity\\Users' . "\0" . 'isVerified', '' . "\0" . 'App\\Entity\\Users' . "\0" . 'benutzname'];
        }
    ...
    public function getBenutzname(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBenutzname', []);

        return parent::getBenutzname();
    }

    /**
     * {@inheritDoc}
     */
    public function setBenutzname(string $benutzname): \App\Entity\Users
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBenutzname', [$benutzname]);

        return parent::setBenutzname($benutzname);
    }
