...
class __TwigTemplate_3f9e8d132bc03133856fabd54964cad1e61477f1efb46ac041e0f29478f7a87b extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        ";
        // line 14
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 14, $this->source); })()), "benutzname", [], "any", false, false, false, 14), 'row');
        echo "
        ";
        // line 15
...
{% block body %}
    ...
    {{ form_start(registrationForm) }}
        ...
        {{ form_row(registrationForm.benutzname) }}
...
{% endblock %}
", "registration/register.html.twig", "C:\\xampp\\htdocs\\symfony\\BodenordnungsVerfahren\\templates\\registration\\register.html.twig");
    }
}
