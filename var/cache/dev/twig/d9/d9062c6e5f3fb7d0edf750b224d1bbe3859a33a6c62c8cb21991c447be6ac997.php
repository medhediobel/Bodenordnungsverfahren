...
<form method=\"post\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            Sie sind eingeloggt als {{ app.user.username }}, <a href=\"{{ path('app_logout') }}\">Abmelden</a>
        </div>
    {% endif %}
...
<p> <a href=\"{{ path('app_forgot_password_request') }}\">Passwort vergessen</a> </p>
{% endblock %}
", "security/login.html.twig", "C:\\xampp\\htdocs\\symfony\\BodenordnungsVerfahren\\templates\\security\\login.html.twig");
    }
}
