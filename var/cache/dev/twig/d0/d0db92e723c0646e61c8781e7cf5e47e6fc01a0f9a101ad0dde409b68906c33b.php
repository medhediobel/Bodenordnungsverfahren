...
class __TwigTemplate_c385313ec642b3e77a34fe6173c0c52a42ffd154adbd80a32518f76b24b8b6a9 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "E-Mail zum Zurücksetzen des Kennworts gesendet";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <p>
        Es wurde eine E-Mail gesendet, die einen Link enthält, auf den Sie klicken können, um Ihr Passwort zurückzusetzen.
    ...
    <p>Wenn Sie keine E-Mail erhalten, überprüfen Sie bitte Ihren Spam-Ordner oder <a href=\"";
        // line 10
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_forgot_password_request");
        echo "\">erneut versuchen</a>.</p>
";
...
{% block title %}E-Mail zum Zurücksetzen des Kennworts gesendet{% endblock %}

{% block body %}
    <p>
        Es wurde eine E-Mail gesendet, die einen Link enthält, auf den Sie klicken können, um Ihr Passwort zurückzusetzen.
        Dieser Link verfällt in {{ resetToken.expirationMessageKey|trans(resetToken.expirationMessageData, 'ResetPasswordBundle') }}.
    </p>
    <p>Wenn Sie keine E-Mail erhalten, überprüfen Sie bitte Ihren Spam-Ordner oder <a href=\"{{ path('app_forgot_password_request') }}\">erneut versuchen</a>.</p>
{% endblock %}
", "reset_password/check_email.html.twig", "C:\\xampp\\htdocs\\symfony\\BodenordnungsVerfahren\\templates\\reset_password\\check_email.html.twig");
    }
}
